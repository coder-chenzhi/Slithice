...
//        }
		...
		for(Unit u: body.getUnits()){
			Collection<Unit> cd = depQuery.getCtrlDependencies(m, u);
			Collection<Unit> rwd = depQuery.getRWDependencies(m, u);
			Collection<Unit> wrd = depQuery.getWRDependencies(m, u);
			Collection<Unit> wwd = depQuery.getWWDependencies(m, u);
	...
	public static void main(String[] args) { 
    	String pta = "spark";
       	Properties conf = Test.loadConfig("../depConfig.xml");
