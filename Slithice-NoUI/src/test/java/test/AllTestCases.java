...
interface AllTestCases{
	...
	static interface DepQuery{
		...
		public static String[] OUTPUT_DEPENDENCE_QUERY = {
				...
				"<test.cases.DepQuery: void testStringBuilder()>"
		};
	}
	...
	//////////////////////// PDG Construction ////////////////////////////
	public final String PDG_MAIN_CLASS = "test.cases.PDG";
   ...
   static interface SideEffect{
	   ...
	   public static String MY_CASES[] = {
			   "<test.cases.SideEffect: void testToString()>",
			   "<test.cases.SideEffect: void testStringBuilder()>",
			   "<test.cases.SideEffect: void testException()>"
	   };
   }
}
