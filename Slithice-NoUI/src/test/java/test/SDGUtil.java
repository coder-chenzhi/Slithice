...
public class SDGUtil implements AllTestCases{  
     ...
     * @param ptstoType can be "spark" or "type-based"
     * */
    ...
    public static void main(String[] args){	
    	...
    	//SootMethod main = Scene.v().getMethod("<test.SDG8: void test1()>");
		...
		//SootMethod check = Scene.v().getMethod("<test.SDG8: test.SDG8$Int add(test.SDG8$Int,test.SDG8$Int)>");
		//Test.showCFG(check);
		//PDG pdg = sdg.getPDG(check);
        //test.SDGUtil.showDependenceGraph(pdg, "./output/dot/pdg.dot");
		
		//test.SDGUtil.showDependenceGraph(sdg,"./output/dot/sdg.dot");
	}
}
