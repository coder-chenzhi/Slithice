...
public class PtsTo {
    ...
    public static void main(String[] args){
        ...
        a.testStringBuilderWrapperFieldAccess();
        StringBuilderWrapper sbw1 = new StringBuilderWrapper();
        StringBuilderWrapper sbw2 = new StringBuilderWrapper();
    ...
    private void testStringBuilderWrapper() {
        StringBuilderWrapper sb1 = new StringBuilderWrapper();
        sb1.append(1);
    ...
    private void testStringBuilderWrapperFieldAccess() {
        StringBuilderWrapper sb1 = new StringBuilderWrapper();
        sb1.sb.append(1);
...
class StringBuilderWrapper {
    ...
    StringBuilderWrapper append(int i) {
        sb.append(i);
        return this;
    }
